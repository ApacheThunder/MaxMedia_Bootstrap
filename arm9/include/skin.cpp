...
static bool intLoadBMBinary(u8 *bmdata, u32 bmsize, u16 *pbm, const u32 bmw, const u32 bmh) {
...
bool LoadSkinFromBinary(int mode, u8 *skinBinary, u32 skinSize) {
	u16	*pDstBuf1, *pDstBuf2;

	pBuf = (u16*)malloc(256*192*2);
	
	if (!intLoadBMBinary(skinBinary, skinSize, pBuf, 256, 192)) { free(pBuf); return false; }
